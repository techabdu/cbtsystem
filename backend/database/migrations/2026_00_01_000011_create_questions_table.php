...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('questions', function (Blueprint $table) {
            ...
            // Answers (JSON — supports MCQ options, T/F, fill-in-blank)
            $table->json('options')->nullable();         // [{key: "A", value: "..."}, ...]
            $table->json('correct_answer')->nullable();  // Single value or array
            ...
            $table->index(['is_verified', 'deleted_at'], 'idx_questions_verified');
        });
    }

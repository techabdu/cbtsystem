    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-background p-4">
            <div className="w-full max-w-md rounded-lg border bg-card p-6 text-center shadow-sm">
                ...
                <h2 className="mb-2 text-lg font-semibold">Exam Display Error</h2>
                <p className="mb-2 text-sm text-muted-foreground">
                    A display error occurred, but <strong>your answers have been auto-saved</strong>.
                </p>
                <p className="mb-6 text-sm text-muted-foreground">
                    Click the button below to reload. If the problem persists, contact your exam supervisor.
                </p>
                <button
                    onClick={reset}

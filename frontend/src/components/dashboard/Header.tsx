...
export function Header() {
    ...
    const roleBadgeColor = {
        ...
        cbt: 'bg-orange-100 text-orange-700 dark:bg-orange-900/30 dark:text-orange-400',
        edu_portal: 'bg-purple-100 text-purple-700 dark:bg-purple-900/30 dark:text-purple-400',
    }[user?.role || 'student'];
